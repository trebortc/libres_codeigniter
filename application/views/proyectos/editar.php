<div class="container-fluid pt-0 pb-5 pr-5 pl-5">
    ...
    <div class="row">
        <div class="col">
            <form method="post" action='<?php echo base_url();?>Proyectos/actualizar/<?php echo $proyecto['id'];?>' enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fecha" name="fecha" value='<?php echo $proyecto['fecha'];?>' placeholder="Ingrese una fecha">
                </div>
                <div class="form-group">
                    <label for="texto">Texto</label>
                    <textarea class="form-control" id="texto" name="texto"><?php echo $proyecto['texto'];?></textarea>
                </div>
                <div class="form-group">
