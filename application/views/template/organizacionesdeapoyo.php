    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-10 col-lg-9 col-xl-9">
            <div class="jumbotron" style="background:transparent !important">
                ...
                <br><a class="btn btn-danger font-weight-bold btn-lg float-right" href="https://itgetsbetter.org/get-help/" role="button" target=”_blank”
target=”_blank”
target=”_blank”>ORGANIZACIONES</a>
            </div>
        </div>
    </div>
</div>