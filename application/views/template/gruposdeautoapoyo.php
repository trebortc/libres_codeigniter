    ...
    <div class="row justify-content-center">
        <div class="col-12 col-sm-10 col-md-10 col-lg-9 col-xl-9">
            <div class="jumbotron" style="background:transparent !important">
                <h1 class="tam-letra-3 font-weight-bold">Grupos de Auto-Apoyo</h1><br>
                ...
                <br><a class="btn btn-danger font-weight-bold btn-lg float-right" href="<?php echo base_url();?>inicio/contacto" role="button">INCLUIRTE A UN GRUPO</a>
            </div>
        </div>
    </div>
</div>